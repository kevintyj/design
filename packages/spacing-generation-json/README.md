...
```bash
bun add @kevintyj/design-spacing-json
```
...
```typescript
import { reorderSpacingOutput } from '@kevintyj/design-spacing-json';
...
```typescript
import { generateTailwindSpacingJSON } from '@kevintyj/design-spacing-json';
...
```typescript
import { generateDesignTokensJSON } from '@kevintyj/design-spacing-json';
...
```typescript
import { generateFigmaCollectionsJSON } from '@kevintyj/design-spacing-json';
...
```typescript
import { generateFlatJSON } from '@kevintyj/design-spacing-json';
...
```json
{
  "metadata": {
    ...
    "remBase": 16,
    "format": "tailwind",
    "generator": "@kevintyj/design-spacing-json",
    "version": "1.0.0"
  }
}
```
